        ...
        <nav class="navbar navbar-expand-xl navbar-white bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <div class=" nav navbar-nav">
                    ...
                    <a href="{{route('admin_materias')}}" class="nav-link text-primary h6 mb-0">Administrar Materias</a>
                ...
                <table class="table table-responsive-lg table-white table-striped ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$materia->name}}</td>
                            <td class="text-center">{{$materia->grado}}{{$materia->grupo}}</td>
                            <td class="text-center">{{$materia->turno}}</td>
                            <td class="text-center">{{$materia->carrera}}</td>
                            <td class="d-flex justify-content-center">
                                ...
                                <form action="{{ url('/carga_materias/'.$materia->id) }}" method="POST">
                                    @csrf
                                    {{method_field('DELETE')}}
                                <button type="submit" onclick="return confirm('¿Deseas borrar esta materia realmete?')" 
