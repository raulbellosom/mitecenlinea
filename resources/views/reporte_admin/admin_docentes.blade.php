...
<div class="container">
    ...
    {{-- Barra de navegación  --}}
        <nav class="navbar navbar-expand-xl navbar-light bg-light">
            <a class="navbar-brand" href="{{url('administrativo/')}}">Panel de Control</a>
            <button class="navbar-toggler bg-light" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
              <div class=" nav navbar-nav">
                    <a href="{{route('admin_docentes')}}" class="nav-link text-primary  h6 mb-0" >Docentes</a>
                    <a class="nav-link text-dark  h6 mb-0" href="#">Materias</a>
                    <a class="nav-link text-dark h6 mb-0" href="#">Reportes</a>
                </div>
            </div>
        </nav>
    {{-- Barra de navegación  --}}
        ...
        <div class="bg-light">
            <div class="mt-4">
                <div class="ml-3 mr-3 p-2 d-md-flex justify-content-md-between align-items-baseline bg-light border border-primary border-bottom-0"> 
                    ...
                    <a href="{{url('user_avance_academico/create')}}" class="btn btn-outline-primary col-12 col-sm-12 col-md-6 col-lg-4"> 
