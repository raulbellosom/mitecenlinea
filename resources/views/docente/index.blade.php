...
<div class="container">
    ...
    <div class="row" >
        ...
        <div class="bg-light pt-4">
            {{-- Barra superior --}}
                <div class="ml-3 mr-3 p-2 d-flex justify-content-between align-items-baseline bg-primary"> 
                    <div>
                        <h5 class="font-weight-bold text-uppercase text-white">Ultimos reportes</h5>
                    </div>
                    <div>
                        <a href="{{url('reporte/index')}}" class="btn btn-outline-light" >
                                ...
                                <td class="d-flex justify-content-between">
                                    @switch($reporte->nombre_reporte)
                                        ...
                                        @case("Reporte Avance Programático")
                                                <a href="{{url('/reporte_avance_programatico/'.$reporte->id.'/edit') }}" class="btn btn-warning">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                    </svg>
                                                ...
                                                @if ($reporte->status == 2)
                                                    <form action="{{url('/download_reporte_avance_programatico/'.$reporte->id)}}" method="GET">
                                                        <button  class="btn btn-success" type="submit">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                                                <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                                                <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                                                ...
                                                @endif
                                                <form action="{{ url('/reporte_avance_programatico/'.$reporte->id) }}" method="POST">
                                                    @csrf
                                                    {{method_field('DELETE')}}
                                                <button type="submit" onclick="return confirm('¿Deseas borrar este reporte?')" 
                                                value="Borrar" class="btn btn-danger">
                                        ...
                                        @case("Reporte Departamental")
                                            <a href="{{url('/reporte_departamental/'.$reporte->id.'/edit') }}" class="btn btn-warning">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg>
                                            ...
                                            <form action="{{ url('/reporte_departamental/'.$reporte->id) }}" method="POST">
                                                @csrf
                                                {{method_field('DELETE')}}
                                            <button type="submit" onclick="return confirm('¿Deseas borrar este reporte?')" 
                                            value="Borrar" class="btn btn-danger">
    ...
    {{-- Administrativo --}}
        @if ($users->typeUser == '2')
            ...
            <div class="row bg-light pt-4 pb-4 d-flex justify-content-evenly" >
                ...
                <div class="col-5 col-md-2 p-4 mt-4 bg-white border border-3 border-success rounded-3">
                    ...
                    <div class="d-flex justify-content-center pt-4">
                        <form action="{{url('/download_reporte_departamental/')}}" method="GET">
                            <button  class="btn btn-primary" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
