...
<div class="container">
        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <div class="nav navbar-nav">
                    <a href="{{url('reporte_diagnostico/')}}" class="nav-link text-primary font-weight-bold" >Reporte Diagnostico</a>
    ...
    {{-- Tabla principal --}}
        <div class="bg-light">
            <div class="mt-4">
                <div class="mt-4 ml-3 mr-3 p-2 d-md-flex justify-content-md-between align-items-baseline bg-light border border-primary border-bottom-0"> 
                    <div class="font-weight-bold text-primary h5 pb-2">
                        Mis Reportes Diagnostico
                    </div>
                    <a href="{{url('reporte_diagnostico/create')}}" class="btn btn-outline-primary col-12 col-sm-12 col-md-6 col-lg-4"> 
