        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <div class=" nav navbar-nav">
                    ...
                    <a class="nav-link text-secondary" href="#">Reporte Final</a>
                </div>
            </div>
        </nav>
    {{-- Barra de navegación  --}}
        ...
        <div class="bg-light">
            <div class="m-4">
                <div class="d-md-flex justify-content-md-between pt-4 ">
                    ...
                    <a href="{{url('reporte_avance_programatico/create')}}" class="btn btn-outline-success col-12 col-sm-12 col-md-6 col-lg-6"> 
