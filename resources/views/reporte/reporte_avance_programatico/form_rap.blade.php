    ...
    <button class="btn btn-outline-success" type="submit">
        ...
        {{-- Titulo --}}
            <div class="bg-primary p-4 mb-1 mt-4 text-center text-light font-weight-bold text-h1 text-uppercase" >
                {{$modo}} Reporte Avance Programático
            </div>
        {{-- Titulo --}}
        ...
        {{-- Información General --}}
            <div class="mb-4 pb-4 bg-light">
                ...
                <div class="m-2 row justify-content-between justify-content-md-around ">
                    ...
                    <div class="form-floating col-12 col-md-6 pb-2">
                        <input id="periodo_monitoreo" class="form-control mr-2" name="periodo_monitoreo" type="text" placeholder="Alumnos ausentes"
                            value="{{ isset($reporte->periodo_monitoreo) ? $reporte->periodo_monitoreo:old('periodo_monitoreo') }}" 
                        >
                        <label for="periodo_monitoreo" class="pl-4">Periodo de Monitoreo </label>
                    </div>
                
                <div class="mw-100 d-flex justify-content-around">
                    <div class="d-flex align-items-center">
                        <input class="form-control " type="hidden" name="nombre_reporte"
                        value="Reporte Avance Programático" id="nombre_reporte"
                        >
                    </div>
                    <div class="d-flex align-items-center">
