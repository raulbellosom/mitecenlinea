...
<body>
    <header>
        <div>
            <img style="width: 100%; height: 100px" src="{{asset('../resources/img/logo/background-top.png')}}" alt="adydo-logo">
        </div>
    </header>
    <footer>
        <img style="width: 100%" src="{{asset('../resources/img/logo/background-bot.png')}}" alt="adydo-logo"  >
    </footer>
    <div>
